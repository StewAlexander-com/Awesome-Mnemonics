...
### Added
- **CHANGELOG.md** — Version history (v1.0, v1.1, v1.5) and maintenance notes
...
- **README** — Integrations line (CLI, runbook, Metrics, Field Reports), CHANGELOG link in Release Versions, flowchart text summary (accessibility)
